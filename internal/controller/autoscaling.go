...
func (r *MisskeyReconciler) reconcileAutoscaler(ctx context.Context, m *misskeyv1alpha1.Misskey, component, targetName string, a *misskeyv1alpha1.AutoscalingSpec, p plan) error {
...
func buildHPASpec(targetName string, a *misskeyv1alpha1.AutoscalingSpec) autoscalingv2.HorizontalPodAutoscalerSpec {
...
func buildScaledObject(m *misskeyv1alpha1.Misskey, component, targetName string, a *misskeyv1alpha1.AutoscalingSpec, ep redisEndpoint) *unstructured.Unstructured {
...
func (r *MisskeyReconciler) deleteHPA(ctx context.Context, m *misskeyv1alpha1.Misskey, targetName string) error {
	hpa := &autoscalingv2.HorizontalPodAutoscaler{ObjectMeta: metav1.ObjectMeta{Name: targetName, Namespace: m.Namespace}}
	return r.deleteIfExists(ctx, hpa)
}

func (r *MisskeyReconciler) deleteScaledObject(ctx context.Context, m *misskeyv1alpha1.Misskey, targetName string) error {
...
func (r *MisskeyReconciler) deleteTriggerAuth(ctx context.Context, m *misskeyv1alpha1.Misskey, targetName string) error {
